...
export default function Layout({ children }) {
  ...
  return (
    <main className="min-h-screen antialiased min-w-screen bg-gradient-to-br from-[rgb(10,15,40)] to-[rgb(5,3,16)]">
      <nav className="fixed flex text-white flex-col font-semibold overflow-y-scroll overflow-x-hidden px-2 pt-5 pb-3 top-0 left-0 h-full w-60 bg-gradient-to-br from-[rgb(10,12,35)] to-[rgb(5,5,20)]">
      ...
      <nav className="fixed bg-gradient-to-r text-white overflow-x-scroll from-[rgb(10,15,40)] to-[rgb(5,3,16)] left-60 px-10 py-4 right-0 top-0 mb-5 z-50 flex items-center justify-between">
